...
static const uint8_t keygen_dsa512_p[] = {
	0xC8, 0x6B, 0xB7, 0x91, 0xD6, 0x63, 0xCE, 0xC0, 0xC6, 0xB8, 0xAC,
	0x5B, 0xEB, 0xA7, 0xEF, 0x17, 0xBE, 0x1A, 0x1A, 0x36, 0x6B, 0x38,
	0x40, 0x0E, 0x69, 0x13, 0x32, 0xD4, 0x4B, 0xBE, 0x00, 0xB5, 0x29,
	0x7F, 0x6B, 0x87, 0xAA, 0x1D, 0x98, 0x37, 0xD2, 0xAC, 0x62, 0x26,
	0xD7, 0xFD, 0xE1, 0xC9, 0x13, 0x4F, 0x2A, 0xF2, 0x82, 0xEC, 0xA8,
	0x83, 0x6F, 0x29, 0xD3, 0xF5, 0x16, 0xB9, 0x13, 0xCD,
};

static const uint8_t keygen_dsa512_q[] = {
	0x8D, 0xF9, 0x8B, 0x8A, 0xDA, 0x3B, 0x0B, 0x1C, 0xFA, 0x1C,
	0xA7, 0xE8, 0x9A, 0xA2, 0xD7, 0xC3, 0x2D, 0xD5, 0x9D, 0x1B,
};

static const uint8_t keygen_dsa512_g[] = {
	0xB3, 0xE2, 0xFD, 0x38, 0xE0, 0x9A, 0x21, 0x64, 0x8F, 0x6D, 0x7E,
	0x4F, 0xC2, 0x24, 0x18, 0x88, 0xEC, 0xA4, 0xCB, 0xB0, 0x5F, 0x43,
	0xD8, 0x2B, 0x5B, 0xDE, 0x01, 0xB4, 0xD2, 0x24, 0x1F, 0x80, 0xE7,
	0xFC, 0xF3, 0x15, 0xFA, 0x0C, 0x5B, 0x6F, 0x81, 0x55, 0x8C, 0x80,
	0x36, 0xFB, 0x4D, 0xB5, 0x8C, 0x5A, 0x26, 0xBE, 0xFB, 0x78, 0xEA,
	0x62, 0x6A, 0x9D, 0x5E, 0xD0, 0x21, 0x0C, 0xD9, 0x4E,
};
...
static const uint8_t keygen_dsa576_q[] = {
	0xF0, 0xD8, 0x71, 0x31, 0xB5, 0x01, 0xC1, 0x6B, 0x09, 0xCE,
	0x7D, 0x2F, 0x82, 0x48, 0xB0, 0x21, 0x9C, 0xD6, 0xB5, 0xB1,
};
...
static const uint8_t keygen_dsa640_q[] = {
	0xD7, 0x63, 0x4F, 0x3E, 0x6D, 0x52, 0x93, 0x69, 0xFA, 0xFF,
	0xDE, 0x0D, 0x57, 0x3F, 0x24, 0xBB, 0x01, 0xF8, 0x01, 0xAD,
};
...
static const uint8_t keygen_dsa704_p[] = {
	0xDA, 0xEA, 0x9B, 0x6B, 0x35, 0x06, 0x2E, 0x7E, 0x71, 0xB2, 0x11,
	0xD0, 0x37, 0x84, 0x88, 0xC0, 0x50, 0x94, 0x73, 0x78, 0xA8, 0x9C,
	0xBD, 0x8C, 0xB1, 0x0A, 0xD5, 0x89, 0x52, 0x39, 0xBF, 0x41, 0xDC,
	0xB9, 0xE5, 0x16, 0x1A, 0x86, 0xD5, 0xCF, 0xD6, 0x26, 0x84, 0x95,
	0xE9, 0x0D, 0xCD, 0x98, 0x21, 0x6B, 0x3C, 0xFE, 0x6D, 0x2D, 0x42,
	0x1A, 0x3F, 0xE0, 0xFF, 0x07, 0x41, 0x82, 0x30, 0x15, 0x17, 0xF3,
	0x0F, 0x7B, 0xA0, 0xD3, 0x46, 0xFA, 0x1F, 0x1E, 0xEC, 0xBD, 0x26,
	0xCE, 0x4C, 0xE3, 0xBD, 0x73, 0xA3, 0xA6, 0xA0, 0x12, 0xE1, 0xFD,
};

static const uint8_t keygen_dsa704_q[] = {
	0xCE, 0xB3, 0x2E, 0x41, 0xEB, 0xFD, 0x22, 0x2A, 0xCE, 0x9A,
	0xAF, 0x24, 0xE3, 0x02, 0x50, 0xDE, 0x47, 0xBC, 0x4C, 0x1F,
};

static const uint8_t keygen_dsa704_g[] = {
	0x08, 0x83, 0x72, 0x6D, 0x0A, 0x8F, 0x19, 0x61, 0xE4, 0x62, 0x40,
	0x29, 0x66, 0x6B, 0xDE, 0xBD, 0xAB, 0xE3, 0x5B, 0x58, 0x3F, 0xF5,
	0xEA, 0xDE, 0x8E, 0x7A, 0x34, 0xAF, 0x1C, 0x99, 0x03, 0x1A, 0x51,
	0x17, 0xFC, 0xE0, 0xA3, 0x22, 0x43, 0x63, 0xB6, 0x7E, 0x29, 0x4B,
	0x23, 0x6C, 0xD1, 0xDE, 0x59, 0xEC, 0x1D, 0x67, 0x94, 0xDD, 0x2E,
	0x88, 0x86, 0xD3, 0xD6, 0x68, 0x58, 0x36, 0x48, 0xF8, 0xEF, 0x38,
	0x3F, 0xF5, 0x87, 0x96, 0x38, 0xD3, 0x48, 0x50, 0x1F, 0xA3, 0x4A,
	0xCA, 0xD7, 0x4D, 0xC3, 0x84, 0x83, 0xB1, 0x8A, 0x95, 0xE0, 0xB3,
};
...
static const uint8_t keygen_dsa768_q[] = {
	0xC9, 0x8C, 0x79, 0x7B, 0x98, 0xB5, 0xFD, 0x80, 0x5D, 0x4B,
	0x26, 0x30, 0x42, 0x63, 0xDE, 0x37, 0xAB, 0x4B, 0xB7, 0xAF,
};
...
static const uint8_t keygen_dsa832_q[] = {
	0xF8, 0xF5, 0xAF, 0x31, 0x0D, 0xBE, 0x6F, 0x4B, 0x79, 0x87,
	0xA2, 0x98, 0xED, 0xF1, 0x2A, 0x93, 0x3D, 0x12, 0x5D, 0x25,
};
...
static const uint8_t keygen_dsa896_q[] = {
	0xAE, 0x42, 0x0A, 0x1D, 0x76, 0xA9, 0xFB, 0xF1, 0xCB, 0x2D,
	0x73, 0x35, 0x3F, 0x98, 0x63, 0x34, 0xE1, 0xCD, 0x3C, 0xCF,
};
...
static const uint8_t keygen_dsa960_q[] = {
	0xCE, 0x0A, 0x68, 0xA4, 0xAC, 0x5E, 0x8E, 0x4C, 0xA6, 0x8A,
	0xAB, 0xA9, 0x39, 0xC7, 0xB4, 0x10, 0xCC, 0xF6, 0x1E, 0x2F,
};
...
static const uint8_t keygen_dsa1024_q[] = {
	0xCC, 0x18, 0x69, 0xCE, 0x9E, 0x92, 0xE7, 0xCD, 0xBF, 0x94,
	0xB5, 0xAD, 0x83, 0x5A, 0x56, 0xD6, 0x4E, 0xC4, 0xF7, 0xED,
};
...
static const uint8_t keygen_dsa2048_q[] = {
	0x8e, 0xc7, 0x3f, 0x37, 0x61, 0xca, 0xf5, 0xfd, 0xfe, 0x6e, 0x4e,
	0x82, 0x09, 0x8b, 0xf1, 0x0f, 0x89, 0x87, 0x40, 0xdc, 0xb8, 0x08,
	0x20, 0x4b, 0xf6, 0xb1, 0x8f, 0x50, 0x71, 0x92, 0xc1, 0x9d,
};
...
static const uint8_t keygen_dsa3072_q[] = {
	0xd3, 0xeb, 0xa6, 0x52, 0x12, 0x40, 0x69, 0x40, 0x15, 0xef, 0x94,
	0x41, 0x2e, 0x08, 0xbf, 0x3c, 0xf8, 0xd6, 0x35, 0xa4, 0x55, 0xa3,
	0x98, 0xd6, 0xf2, 0x10, 0xf6, 0x16, 0x90, 0x41, 0x65, 0x3b,
};
...
#define DSA_ATTR(size) \
	attrs[0].attributeID = TEE_ATTR_DSA_PRIME; \
	attrs[0].content.ref.buffer = (void *)keygen_dsa##size##_p; \
	attrs[0].content.ref.length = ARRAY_SIZE(keygen_dsa##size##_p); \
	attrs[1].attributeID = TEE_ATTR_DSA_SUBPRIME; \
	attrs[1].content.ref.buffer = (void *)keygen_dsa##size##_q; \
	attrs[1].content.ref.length = ARRAY_SIZE(keygen_dsa##size##_q); \
	attrs[2].attributeID = TEE_ATTR_DSA_BASE; \
	attrs[2].content.ref.buffer = (void *)keygen_dsa##size##_g; \
	attrs[2].content.ref.length = ARRAY_SIZE(keygen_dsa##size##_g);

TEE_Result dsa_prepare_key(uint32_t ta_key __unused, TEE_ObjectHandle *key,
			   ...
			   unsigned int *nb_attrs)
{
	...
	*nb_attrs = 3;
	...
	res = TEE_AllocateTransientObject(TEE_TYPE_DSA_KEYPAIR, key_size_bits,
					  key);
	if (res) {
